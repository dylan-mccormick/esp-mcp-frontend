...
import { ChatContext, type BaseChatMessage, type ContentBlock, type ToolResultBlock, type ToolUseBlock } from "../context/ChatContext";
...
const useSendMessage = () => {
    ...
    const runMessageLoop = useCallback(async (conversationHistory: Omit<BaseChatMessage, "id">[]) => {
        let cont = true;
        while (cont) {
            ...
            setMessages(prev => prev.map(m => {
                ...
                const updatedContent = m.content.map(block => {
                    ...
                    if (parsedObj instanceof Object && parsedObj.content && parsedObj.content[0].type === "text") {
